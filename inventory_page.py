...
class InventoryPage(QWidget):
    ...
    def init_ui(self):
        ...
        self.search_input.setMinimumWidth(300)  # 设置一个明显的宽度
        ...
        self.Inventory_table.verticalHeader().setSectionResizeMode(QHeaderView.ResizeMode.Fixed)
        self.Inventory_table.verticalHeader().setDefaultSectionSize(25) 
        self.Inventory_table.verticalHeader().setFixedWidth(50)
        ...
        self.headers = [
            "ID", "名称 (Name)", "物品型号 (Ref)", "材料类别", "专业类别", "单位", 
    ...
    def _apply_column_widths(self):
        ...
        self.Inventory_table.setColumnWidth(5, 90)
        self.Inventory_table.setColumnWidth(6, 100)
        self.Inventory_table.setColumnWidth(7, 100)
        self.Inventory_table.setColumnWidth(8, 100)
        self.Inventory_table.setColumnWidth(9, 100)
        self.Inventory_table.setColumnWidth(10, 100)
